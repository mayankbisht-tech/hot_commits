      ...
      if (normalizedRole === 'STUDENT') {
        ...
        const student = await tx.student.create({
          data: {
            ...
            class10: Number(body.class10) || 80,
            class12: Number(body.class12) || 80,
            graduationYear: Number(body.graduationYear) || 2024,
            placementStatus: 'UNPLACED',
            dreamEligible: cgpa >= 8.5,
            resumeVerified: false,
            skillsJson: JSON.stringify(body.skills || ['JavaScript', 'React', 'Problem Solving']),
          }
        });
